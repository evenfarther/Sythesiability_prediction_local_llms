...
# -*- coding: utf-8 -*-
"""
Build a random-initialized Qwen3-14B checkpoint (FP16/BF16).
...
def main() -> None:
    p = argparse.ArgumentParser(description="Make random-init Qwen3-14B checkpoint (no pretrained weights).")
    p.add_argument(
        "--base_model_id",
        type=str,
